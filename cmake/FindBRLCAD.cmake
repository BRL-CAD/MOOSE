...
FOREACH(brl_lib ${BRL-CAD_LIBS_SEARCH_LIST})
    STRING(TOUPPER ${brl_lib} LIBCORE)
    FIND_LIBRARY(BRLCAD_${LIBCORE}_STATIC_LIBRARY NAMES ${brl_lib}${CMAKE_STATIC_LIBRARY_SUFFIX} lib${brl_lib}${CMAKE_STATIC_LIBRARY_SUFFIX} PATHS ${BRLCAD_LIB_DIR} NO_SYSTEM_PATH)
ENDFOREACH(brl_lib ${BRL-CAD_LIBS_SEARCH_LIST})
...
FOREACH(ext_lib ${BRL-CAD_SRC_OTHER_REQUIRED})
    STRING(TOUPPER ${ext_lib} LIBCORE)
    FIND_LIBRARY(BRLCAD_${LIBCORE}_STATIC_LIBRARY NAMES ${ext_lib}${CMAKE_STATIC_LIBRARY_SUFFIX} lib${ext_lib}${CMAKE_STATIC_LIBRARY_SUFFIX} ${ext_lib}_brl${CMAKE_STATIC_LIBRARY_SUFFIX} lib${ext_lib}_brl${CMAKE_STATIC_LIBRARY_SUFFIX} PATHS ${BRLCAD_LIB_DIR} NO_SYSTEM_PATH)
ENDFOREACH(ext_lib ${BRL-CAD_SRC_OTHER_REQUIRED})
