...
#  zlib
FIND_LIBRARY(ZLIB_LIBRARY NAMES z zlib zdll z_brl PATHS ${BRLCAD_LIB_DIR})
FIND_LIBRARY(ZLIB_STATIC_LIBRARY NAMES z${STATIC_LIBRARY_SUFFIX} zlib${STATIC_LIBRARY_SUFFIX} zdll${STATIC_LIBRARY_SUFFIX} z_brl${STATIC_LIBRARY_SUFFIX} PATHS ${BRLCAD_LIB_DIR} NO_SYSTEM_PATH)
IF("${ZLIB_STATIC_LIBRARY}" STREQUAL "ZLIB_STATIC_LIBRARY-NOTFOUND")
    # if there is a system library, use it
    FIND_LIBRARY(ZLIB_STATIC_LIBRARY NAMES z zlib zdll)
...
#  libregex
FIND_LIBRARY(REGEX_LIBRARY NAMES regex compat regex_brl PATHS ${BRLCAD_LIB_DIR})
FIND_LIBRARY(REGEX_STATIC_LIBRARY NAMES regex${STATIC_LIBRARY_SUFFIX} compat${STATIC_LIBRARY_SUFFIX} regex_brl${STATIC_LIBRARY_SUFFIX} PATHS ${BRLCAD_LIB_DIR} NO_SYSTEM_PATH)
IF("${REGEX_STATIC_LIBRARY}" STREQUAL "REGEX_STATIC_LIBRARY-NOTFOUND")
    # if there is a system library, use it
    FIND_LIBRARY(REGEX_STATIC_LIBRARY NAMES regex compat)
