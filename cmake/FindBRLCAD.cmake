...
IF(NOT BRLCAD_BASE_DIR)
    ...
    IF(NOT BRLCAD_BASE_DIR)
        ...
        IF(BRLCAD_CONFIGEXE)
            EXECUTE_PROCESS(COMMAND ${BRLCAD_CONFIGEXE} --prefix OUTPUT_VARIABLE BRLCAD_BASE_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
...
IF(BRLCAD_CONFIGEXE)
    EXECUTE_PROCESS(COMMAND ${BRLCAD_CONFIGEXE} --version OUTPUT_VARIABLE BRLCAD_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
